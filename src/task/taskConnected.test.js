...
describe('task connected', () => {
    ...
    test('add task', async () => {
        ...
        const profile = sample.profile()
        const uri = `/task/${profile.id}`
        const task = sample.task({profile: profile.id})
    ...
    test('mark task complete', async () => {
        ...
        const profile = sample.profile()
        const uri = `/task/${profile.id}`
        const incompleteTask = sample.task({profile: profile.id})
    ...
    test('clear completed tasks', async () => {
        ...
        const uri = `/task/${profile.id}`
        const incompleteTask = sample.task({profile: profile.id})
        const completeTask = sample.task({profile: profile.id, complete: true})
